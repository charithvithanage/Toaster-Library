package com.example.toasterlibrary.caldroid;
...
public class CaldroidFragment extends DialogFragment implements View.OnTouchListener {
    /**
     * Weekday conventions
     */
    public static int
...
//
//        monthTitleTextView.setOnTouchListener(this);
...
//        });
    ...
    private void setupDateGridPages(View view) {
        ...
        // Set enable swipe
        dateViewPager.setEnabled(enableSwipe);
//        dateViewPager.setPageTransformer(true, new StackTransformer());
